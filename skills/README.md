...
1. [oz-start.md](oz-start.md) for starting serious goals.
2. [failure-radar.md](failure-radar.md) for prediction.
3. [countermap-50.md](countermap-50.md) for counter planning.
4. [ybr.md](ybr.md) for route selection.
5. [oz-result.md](oz-result.md) for closeout.
